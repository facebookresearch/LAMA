...
def main(args):
    ...
    if not args.text and not args.interactive:
        msg = (
            "ERROR: either you start LAMA eval_generation with the "
        ...
        for model_name, model in models.items():
            ...
            if vocab_subset is not None:
                ...
                (
                    ...
                    index_list,
                ) = model.init_indices_for_filter_logprobs(vocab_subset)
            ...
            if masked_indices and len(masked_indices) > 0:
                evaluation_metrics.get_ranking(
            ...
            print_sentence_predictions(
                original_log_probs_list[0],
                token_ids,
                model.vocab,
